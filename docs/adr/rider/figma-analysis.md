...
## ADR ↔ Figma 화면 매핑 (10장 인덱스)

| Figma 파일 | ADR 관련 |
|---|---|
| `스크린샷 2026-05-05 17{0116, 0121}.png` | ADR-001 회원가입/로그인 |
| `스크린샷 2026-05-05 17{0125, 0131}.png` | ADR-004 상태 머신 (배차/픽업 모달) |
| `스크린샷 2026-05-05 17{0137, 0143}.png` | ADR-005 위치 추적 (지도 + 실시간) |
| `스크린샷 2026-05-05 17{0148}.png` | ADR-007 정산 화면 |
| `스크린샷 2026-05-05 17{0153}.png` | ADR-008 근무관리 + 토글 |
| `스크린샷 2026-05-05 17{0158, 0202}.png` | ADR-009 공지사항 + ADR-002 모델 종합 |

> **주의**: 위 매핑은 파일명 시간순 추정. ADR 작성 시 정확한 매핑은 사용자 검토 후 재조정 가능. 각 ADR에서 `../../figma/` 디렉토리 전체 참조로 표기.
